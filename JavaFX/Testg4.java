...
public class Testg4 extends Application{
...
class BreakoutThread extends AnimationTimer{
	...
	BreakoutThread(GraphicsContext gc,Key key){
		...
		cd = new CollisionDetection(this,ball,bar,block,field);
		game_state = 0;
	}
...
class CollisionDetection{
	...
	CollisionDetection(BreakoutThread breakoutthread,Ball ball,Bar bar,Blocks block,Field field){
