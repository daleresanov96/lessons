...
class Animators extends Group{
	public Animators() {
		...
		TranslateTransition anm01 = new TranslateTransition(Duration.seconds(2),rect02);
		anm01.setFromX(0);anm01.setToX(525);
		anm01.setFromY(0);anm01.setToY(525);

		FillTransition anm02 = new FillTransition(Duration.seconds(2),rect02);
		anm02.setFromValue(Color.PURPLE);
		anm02.setToValue(Color.BLUE);

		ScaleTransition anm03 = new ScaleTransition(Duration.seconds(2),rect02);
		anm03.setFromX(1);anm03.setToX(2);
		anm03.setFromY(1);anm03.setToY(2);

		RotateTransition anm04 = new RotateTransition(Duration.seconds(2),rect01);
		...
		StrokeTransition anm06 = new StrokeTransition(Duration.seconds(2),rect01);
		...
		rect03.setFill(lg);
		rect01.setFill(null);
		getChildren().add(rect03);
		getChildren().add(rect04);
		getChildren().add(rect01);
		getChildren().add(rect02);
		getChildren().add(crc);
		getChildren().add(tx);
